...
%
L’espace PR est normal à 180 ms.%
\subsection*{Auriculogramme:}%
\label{subsec:Auriculogramme}%

%
Les ondes P sont présentes et associées à une HAG.%
\subsection*{Ventriculogramme}%
\label{subsec:Ventriculogramme}%

%
Le complexe QRS est élargi à 120 ms, avec un BBDc (bloc de branche droit complet).%
\subsection*{Repolarisation}%
\label{subsec:Repolarisation}%

%
Un sous{-}décalage du segment ST est observé en DII, DIII et aVF, accompagné d'ondes T aplaties en V4{-}V6.%
\subsection*{Segment QT}%
\label{subsec:SegmentQT}%

%
Le QT est mesuré à 440 ms. La fréquence cardiaque est de 82 bpm, le QTc corrigé calculé selon la formule de Bazett est de 456 ms. Absence d’anomalies du segment QT.%
\\%
%
\vspace*{\baselineskip}%
Remarques:%
...
\item%
Présence d’une hypertrophie auriculaire gauche (HAG).%
\end{itemize}%
%
\vspace*{\baselineskip}%
\end{document}