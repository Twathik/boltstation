...
def Sept_calcification_description(segments: List[CoronarySegmentDescription]):
...
def Sept_calcification_No_stenosis_generator(state: CoronarySegmentation):
    ...
    for lesion in lesions:
        report += Sept_calcification_description(lesion)
