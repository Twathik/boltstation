from src.lib.generate_coronarography.generators.segment_generators.Sept.Sept_Calcification_No_stenosis import (
    Sept_calcification_No_stenosis_generator,
)
from src.lib.generate_coronarography.generators.segment_generators.Sept.Sept_Stent_No_lesion import (
    Sept_stent_No_lesion_generator,
)
from src.lib.generate_coronarography.generators.segment_generators.Sept.Sept_Thrombus_No_stenosis import (
...
from src.lib.generate_coronarography.generators.segment_generators.Sept.Sept_stenosis import (
