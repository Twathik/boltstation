from src.lib.generate_coronarography.generators.segment_generators.LM.LM_Calcification_No_stenosis import (
    LM_calcification_No_stenosis_generator,
)
from src.lib.generate_coronarography.generators.segment_generators.LM.LM_Stent_No_lesion import (
    LM_stent_No_lesion_generator,
)
from src.lib.generate_coronarography.generators.segment_generators.LM.LM_Thrombus_No_stenosis import (
...
from src.lib.generate_coronarography.generators.segment_generators.LM.LM_stenosis import (
