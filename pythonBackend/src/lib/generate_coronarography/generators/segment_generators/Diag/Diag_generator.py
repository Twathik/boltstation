from src.lib.generate_coronarography.generators.segment_generators.Diag.Diag_Calcification_No_stenosis import (
    Diag_calcification_No_stenosis_generator,
)
from src.lib.generate_coronarography.generators.segment_generators.Diag.Diag_Stent_No_lesion import (
    Diag_stent_No_lesion_generator,
)
from src.lib.generate_coronarography.generators.segment_generators.Diag.Diag_Thrombus_No_stenosis import (
...
from src.lib.generate_coronarography.generators.segment_generators.Diag.Diag_stenosis import (
