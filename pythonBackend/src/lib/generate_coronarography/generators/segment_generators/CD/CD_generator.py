from src.lib.generate_coronarography.generators.segment_generators.CD.CD_Calcification_No_stenosis import (
    CD_calcification_No_stenosis_generator,
)
from src.lib.generate_coronarography.generators.segment_generators.CD.CD_Stent_No_lesion import (
    CD_stent_No_lesion_generator,
)
from src.lib.generate_coronarography.generators.segment_generators.CD.CD_Thrombus_No_stenosis import (
...
from src.lib.generate_coronarography.generators.segment_generators.CD.CD_stenosis import (
