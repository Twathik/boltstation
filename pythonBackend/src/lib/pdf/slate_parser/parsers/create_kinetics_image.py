from pylatex import Document, NoEscape, MiniPage


def create_kinetic_image(
    doc: Document, kinetics_type: str, color: str, config: dict, display_count: int
):

    with doc.create(
        MiniPage(width=NoEscape(f"{1/display_count}\\linewidth"))
    ) as column:
        column.append(NoEscape(r"\def \globalscale {0.50000}"))
        column.append(NoEscape(r"\centering"))
        column.append(
            NoEscape(
                f"""		
		\\begin{{tikzpicture}}[y=1cm, x=1cm, yscale=\\globalscale,xscale=\\globalscale, every node/.append style={{scale=\\globalscale}}, inner sep=0pt, outer sep=0pt]
			...
			\\begin{{scope}}[even odd rule,line join=round,miter limit=2.0,shift={{(-3.1277, 6.0325)}}]
				...
				\\path[fill={color if config['sgt16'] == True else 'kinetic_base_color'},even odd rule,line join=round,miter limit=2.0] (8.818, -3.116) -- (8.1317, -2.3761).. controls (8.2095, -2.2824) and (8.433, -2.0449) .. (8.4806, -1.7578).. controls (8.5006, -1.6376) and (8.484, -1.4306) .. (8.4185, -1.23).. controls (8.3514, -1.0244) and (8.2336, -0.9014) .. (8.2336, -0.9014).. controls (8.3041, -0.8365) and (8.9411, -0.2401) .. (8.9411, -0.2401).. controls (9.0647, -0.3792) and (9.0377, -0.323) .. (9.2056, -0.5635).. controls (9.366, -0.7934) and (9.3888, -0.8579) .. (9.4591, -1.1661).. controls (9.4891, -1.2975) and (9.5184, -1.4516) .. (9.5206, -1.5852).. controls (9.5231, -1.74) and (9.497, -1.9083) .. (9.4675, -2.0279).. controls (9.4123, -2.2508) and (9.2407, -2.6173) .. (9.1456, -2.7501).. controls (9.0505, -2.8828) and (8.818, -3.116) .. (8.818, -3.116) -- cycle;
				...
				\\begin{{scope}}[even odd rule,line join=round,miter limit=2.0,cm={{ 1.0882,-0.0,-0.0,1.0882,(-0.9463, 0.3074)}}]
					\\path[fill={color if config['sgt17'] == True else 'kinetic_base_color'},even odd rule,line join=round,miter limit=2.0] (7.7559, -1.7515) circle (0.8807cm);
				...
				\\path[fill={color if config['sgt6'] == True else 'kinetic_base_color'},even odd rule,line join=round,miter limit=2.0] (11.8942, -1.5483).. controls (11.8942, -1.5483) and (11.8898, -0.6298) .. (11.567, 0.048).. controls (11.2442, 0.7257) and (10.6498, 1.4088) .. (10.4266, 1.6313).. controls (10.1851, 1.8721) and (9.832, 2.051) .. (9.832, 2.051) -- (9.2186, 1.1649).. controls (9.3977, 1.0245) and (9.6934, 0.829) .. (9.8535, 0.6173).. controls (10.0046, 0.4177) and (10.1888, 0.2048) .. (10.3237, -0.0811).. controls (10.4559, -0.3613) and (10.5234, -0.4273) .. (10.6277, -0.8697).. controls (10.7319, -1.3122) and (10.7289, -1.5502) .. (10.7289, -1.5502).. controls (11.0985, -1.5644) and (11.8942, -1.5483) .. (11.8942, -1.5483) -- cycle;
				...
				\\end{{scope}}
				\\path[fill={color if config['sgt9'] == True else 'kinetic_base_color'},even odd rule,line join=round,miter limit=2.0] (4.2939, -1.5343).. controls (4.2939, -1.5343) and (4.3617, -2.2128) .. (4.4185, -2.3895).. controls (4.4754, -2.5662) and (4.739, -3.1521) .. (4.8697, -3.334).. controls (5.0005, -3.5159) and (5.0776, -3.6839) .. (5.2426, -3.8497).. controls (5.4077, -4.0155) and (5.5856, -4.1976) .. (5.5856, -4.1976) -- (6.2025, -3.3344).. controls (6.1071, -3.2445) and (5.7548, -2.8341) .. (5.5656, -2.4142).. controls (5.3854, -2.0143) and (5.405, -1.5478) .. (5.405, -1.5478).. controls (5.3139, -1.5408) and (4.2939, -1.5343) .. (4.2939, -1.5343) -- cycle;
				...
				\\path[fill={color if config['sgt10'] == True else 'kinetic_base_color'},even odd rule,line join=round,miter limit=2.0] (5.6123, -4.217).. controls (5.6123, -4.217) and (6.2734, -4.5997) .. (6.5771, -4.6894).. controls (6.8808, -4.7791) and (7.5316, -4.861) .. (8.0248, -4.7722).. controls (8.2433, -4.7328) and (8.5056, -4.6685) .. (8.7136, -4.5821).. controls (8.9584, -4.4804) and (9.1501, -4.384) .. (9.146, -4.3608).. controls (9.132, -4.282) and (8.5726, -3.3911) .. (8.5726, -3.3911).. controls (8.4604, -3.4392) and (8.1607, -3.6193) .. (7.9372, -3.6724).. controls (7.6692, -3.7362) and (7.1271, -3.6981) .. (7.026, -3.6698).. controls (6.9249, -3.6415) and (6.4351, -3.476) .. (6.3607, -3.4274).. controls (6.2862, -3.3788) and (6.2217, -3.3514) .. (6.2217, -3.3514).. controls (6.17, -3.4351) and (5.6123, -4.217) .. (5.6123, -4.217) -- cycle;
        ...
        column.append(NoEscape(f"\\textbf{{\\ul{{{kinetics_type}}}}}%"))
