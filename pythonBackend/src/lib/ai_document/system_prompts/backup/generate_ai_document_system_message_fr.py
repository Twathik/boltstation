...
- Absence de frottement péricardique ou de bruits de galops
...
<Description>"Auscultation cardiaque" correspond à l'examen clinique réalisé à l'aide d'un stéthoscope pour écouter les bruits produits par le cœur. Elle permet de détecter des anomalies telles que : 
- **Bruits cardiaques anormaux** : Souffles, frottements péricardiques, ou bruits de galops. 
- **Rythme cardiaque** : Régulier ou irrégulier (arythmies). 
- **Intensité des bruits** : Révélant des pathologies valvulaires (sténose, insuffisance). 
