...
def RVG_segments_parser(state: CoronarySegmentation):

    RVG_ostium = state.RVG_ostium.lesion
    RVG_proximal = state.RVG_proximal.lesion
    RVG_distal = state.RVG_distal.lesion
...
def RVG_lesions_parser(state) -> List[CoronaryLesionDescription]:
