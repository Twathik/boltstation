from src.lib.ai_document.data_injectors.generate_coronarography.generators.segment_generators.Bisec.Bisec_Calcification_No_stenosis import (
    Bisec_calcification_No_stenosis_generator,
)
from src.lib.ai_document.data_injectors.generate_coronarography.generators.segment_generators.Bisec.Bisec_Stent_No_lesion import (
    Bisec_stent_No_lesion_generator,
)
from src.lib.ai_document.data_injectors.generate_coronarography.generators.segment_generators.Bisec.Bisec_Thrombus_No_stenosis import (
...
from src.lib.ai_document.data_injectors.generate_coronarography.generators.segment_generators.Bisec.Bisec_stenosis import (
...
def Bisec_generator(state: CoronarySegmentation) -> str:
    ...
    if lesion_number == 0 and all_anomalies == 0:
        return "Absence de lésions angiographiques au niveau de l'artère bissectrice."
